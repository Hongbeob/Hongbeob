...
- **담당역할**: ROS2 토픽과 MQTT를 활용한 하드웨어 상태정보 실시간 전송, 센서 트리거 기반 카메라 자동 구동 및 프레임 추출·WebSocket 서버 전송, 하드웨어 설계
...
- **담당역할**: JWT 기반 회원가입 및 사용자 인증 시스템 구축, WebSocket 기반 시그널링 서버 구현을 통한 WebRTC P2P 실시간 통신 지원
...
- **담당역할**: 라즈베리파이와 리모컨 간 블루투스 통신 기반 M:1 연결 구현, 서버와 HTTP 통신 연동 및 웹 프론트엔드 개발
